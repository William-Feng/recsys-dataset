...
def test_evaluate_sessions():
    k = 3
    predictions = {
        1: {"clicks": [1, 2, 3], "carts": [1, 2, 3], "orders": [1, 32, 33]},
        2: {
            "clicks": [1000003, 2, 3],
            "carts": [1000004, 2, 3, 1000007],
            "orders": [1, 2, 3],
        },
        3: {"clicks": [1, 2, 3], "carts": [1000007, 1000004, 3], "orders": [1, 2, 3]},
    }
    labels = {
        1: {
            "clicks": None,
    ...
    expected = {
        1: {"clicks": None, "carts": None, "orders": 1},
        2: {"clicks": 1, "carts": 1, "orders": 0},
        3: {"clicks": 0, "carts": 2, "orders": None},
        4: {"clicks": 0, "carts": 0, "orders": None},
    }
